...
<html>
	...
	<head>
		...
		<title>Developer PHP Test - Elleven Research</title>
	...
	<body>
		...
		<table width="100%" border="1">
			<thead>
				...
				<tr>
					<th width="25%" > <b>Questions</b></th>
                    <th > <b>Answers</b> </th>
				</tr>
			</thead>
			<tbody>
                <tr>
                    <td>Existem ____ preposições no Texto B.</td>
                    <td><strong><?php echo $Elleven->countPrepositions($string_B) ?></strong></td>
                </tr>
                <tr>
                    <td>Há ____ verbos no Texto B</td>
                    <td><strong><?php echo $Elleven->countVerbs($string_B) ?></strong></td>
                </tr>
                <tr>
                    <td>Há ____ verbos em primeira pessoa no Texto B.</td>
                    <td><strong><?php echo $Elleven->countVerbs($string_B, true) ?></strong></td>
                </tr>

                <tr>
                    <td>Como seria a lista de vocabulário do Texto B? </td>
                    <td><strong><?php echo $Elleven->listVocabulary($string_B) ?></strong></td>
                </tr>
                <tr>
                    <td> No Texto B, há ____ números bonitos distintos</td>
                    <td><strong><?php echo $Elleven->prettyNumbers($string_B) ?></strong></td>
                </tr>
